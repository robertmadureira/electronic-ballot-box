let seuVotoPara = document.querySelector('.p-1-1 span');
let cargo = document.querySelector('.p-1-2 span');
let descricao = document.querySelector('.p-1-4');
let aviso = document.querySelector('.parte2');
let lateral = document.querySelector('.parte1-right');
let numeros = document.querySelector('.p-1-3');
